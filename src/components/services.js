  ...
  return (
    <div className="flex">
      <div className="flex-shrink-0">
        <div className="flex items-center justify-start h-12 w-12 text-primary">
          {icon}
        </div>
      </div>
      <div className="ml-3">
      ...
      <div className="container mx-auto py-24">
        <div className="max-w-screen-xl mx-auto px-8">
          <div className="text-center">
            <h3 className="text-4xl leading-8 font-extrabold tracking-tight text-black">
              Why Vincar
            </h3>
          ...
          <div className="mt-10">
            <ul className="grid md:grid-cols-2 col-gap-12 row-gap-6">
              <li>
                <ServiceItem
                  icon={
                    <svg
